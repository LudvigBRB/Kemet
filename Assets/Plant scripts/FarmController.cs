...
public class FarmController : MonoBehaviour
{
    ...
    void PlantFlax(Vector3 position)
    {
        ...
        point = Camera.main.ScreenToWorldPoint(new Vector3(position.x, mousePos.y - 500, Camera.main.nearClipPlane + 8)); //change the height at which the plant appears at Camera.main.nearClipPlane
        //Debug.Log(point);
    ...
    void PlantWheat(Vector3 position)
    {
        ...
        point = Camera.main.ScreenToWorldPoint(new Vector3(position.x, mousePos.y - 560, Camera.main.nearClipPlane + 8)); //change the height at which the plant appears at mousePos.y - x
        //Debug.Log(point);
